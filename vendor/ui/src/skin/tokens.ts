 ...
 *  to a teal dark accent in its own `.dark` CSS block instead (see
 *  src/styles.css's AMENDMENT comment). This DARK_BRAND_TOKENS purple value
 *  is still canonical for other consumers (e.g. xcamp-nox-founder-app) that
 *  want the Nox identity — see xcamp-designsystem's CONFLICTS.md #2. */
