  ...
  useEffect(() => {
    ...
    Promise.all([
      supabase
        .from("notes")
        .select(
          "id, title, body_html, note_type, tags, detail, tenant_id, owner_central_id, created_at, updated_at",
        )
        .eq("id", id)
        .single(),
      listProjects(user!),
  ...
  if (type === "objective") {
    return (
      <div style={{ display: "flex", flexDirection: "column", flex: 1, overflow: "hidden" }}>
        ...
        <div
          style={{ padding: "12px 20px", borderTop: "1px solid var(--skin-line)", flexShrink: 0 }}
        >
