 ...
 *
 * Currently behaviorally identical to AppSidebar — the experimental content goes here.
 * A subtle header tint makes the variant visually identifiable during testing.
 */
                      ...
                      <SidebarMenuSub>
                        ...
                        <SidebarMenuSubItem>
                          <SidebarMenuSubButton asChild isActive={isNavSubActive("network")}>
                            <Link to="/navigator" search={{ view: "network" }} className="flex items-center gap-2">
