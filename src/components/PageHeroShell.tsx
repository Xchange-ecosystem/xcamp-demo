      ...
      >
        ...
        */}
        <div
          ...
          className="absolute inset-0 pointer-events-none"
          style={{
            background: "linear-gradient(135deg, rgba(52,172,191,0.45) 0%, transparent 60%)",
        ...
        <div
          ...
          className="absolute inset-0 pointer-events-none"
          style={{
            background: "linear-gradient(to bottom, rgba(77,224,193,0.22) 0%, transparent 55%)",
          }}
        />
        <div
          aria-hidden
          ...
          {hasHeader && (
            ...
            >
              <div className={align === "center" ? "mx-auto" : "min-w-0"}>
                {logo && <div className="mb-2 sm:mb-3">{logo}</div>}
                {eyebrow && (
                ...
                {title && (
                  <h1
                    className="mt-0.5 sm:mt-1 text-xl sm:text-3xl md:text-4xl font-semibold tracking-tight"
                ...
                {subtitle && (
                  <p
                    className="mt-1 sm:mt-2 text-[13px] sm:text-base"
